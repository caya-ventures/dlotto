...
const asset_entry = path.join("src", "dlotto_assets", "src", "index.html");
...
module.exports = {
  ...
  output: {
    filename: "index.js",
    path: path.join(__dirname, "dist", "dlotto_assets"),
  },
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        {
          from: path.join(__dirname, "src", "dlotto_assets", "assets"),
          to: path.join(__dirname, "dist", "dlotto_assets"),
        },
      ],
    }),
  ...
  devServer: {
    ...
    hot: true,
    contentBase: path.resolve(__dirname, "./src/dlotto_assets"),
